          ...
          <AnimatePresence>
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-6 lg:gap-8 mb-16 sm:mb-20 md:mb-28">
                    ...
                    {projectData.demoAccount && (
                      <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-lg border border-gray-200">
                        ...
                        <span className="text-[13px] font-medium text-gray-700">
                          {projectData.demoAccount.id} /{' '}
                          {projectData.demoAccount.password}
                        </span>
                      </div>
                    )}
                  </div>
                ...
                <div className="w-full lg:hidden flex flex-col gap-3 sm:gap-4">
                  ...
                  {projectData.demoAccount && (
                    <div className="flex items-center justify-center gap-2 px-4 py-2 bg-gray-100 rounded-lg border border-gray-200">
                      <span className="text-[12px] text-gray-500">
                        테스트 계정
                      </span>
                      <span className="text-[13px] font-medium text-gray-700">
