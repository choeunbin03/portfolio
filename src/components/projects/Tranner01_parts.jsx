...
const Tranner01Parts = ({ parts }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="group">
        {/* 이미지 컨테이너 */}
        <div className={`mb-4 sm:mb-6 ${parts[activeTab].images.length > 1 ? 'grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5' : 'flex justify-center'}`}>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200">
          <div className="flex items-center gap-2 mb-3 sm:mb-4">
            ...
            <span className="text-[13px] sm:text-[14px] md:text-[15px] font-semibold text-gray-700">구현 내용</span>
          </div>
