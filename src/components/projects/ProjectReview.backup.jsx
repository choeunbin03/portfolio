        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {review.challenges.map((challenge, index) => (
              <div
                key={index}
                className="bg-gray-50/30 rounded-lg p-5 border border-gray-200 hover:shadow-md transition-shadow"
              >
      ...
      {review.reflection && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {review.reflection.learned && review.reflection.learned.length > 0 && (
            <div className="bg-gray-50/30 rounded-lg p-6 border border-gray-200">
